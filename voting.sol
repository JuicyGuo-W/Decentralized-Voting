...
contract Voting {
    ...
    struct Proposal {
        ...
        uint256 maxVotingNum;
        bool isActive;
    }

    mapping(uint256 => Proposal) public Proposals;
    mapping(uint256 => Candidate[]) public proposalCandidates;
    mapping(uint256 => mapping(address => uint256)) public hasVotedOnProposal;
    ...
    function vote(uint256 _proposalNum, string memory _candidateId) public {
        require(
            hasVotedOnProposal[_proposalNum][msg.sender] < Proposals[_proposalNum].maxVotingNum,
        ...
        hasVotedOnProposal[_proposalNum][msg.sender] += 1;
